...
public class NetworkParameters {
    ...
    private static final int bip32HeaderP2PKHpubTEST = 0x043587cf; // The 4 byte header that serializes in base58 to "tpub".
    private static final int bip32HeaderP2PKHprivTEST = 0x04358394; // The 4 byte header that serializes in base58 to "tprv"

    private static final int bip32HeaderP2PKHpubMAIN = 0x0488b21e; // The 4 byte header that serializes in base58 to "xpub".
    private static final int bip32HeaderP2PKHprivMAIN = 0x0488ade4; // The 4 byte header that serializes in base58 to "xprv"

    private static final int DUMPED_PRIVATE_HEADER_MAIN = 128;
    private static final int DUMPED_PRIVATE_HEADER_TEST = 239;
    ...
    public static List<NetworkType> getNetworkTypes(int version) {
        switch (version) {
            case 0:
            case 5:
                return List.of(NetworkType.MAIN);
            case 111:
            case 196:
